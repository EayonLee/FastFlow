import { workflow_graph } from '@/shared/utils/workflowGraph.js'
import { workflow_meta } from '@/shared/utils/workflowMeta.js'

export function initializeInjectBridge() {
  if (window.__FASTFLOW_INJECT_INITIALIZED__) return

  window.__FASTFLOW_INJECT_INITIALIZED__ = true
